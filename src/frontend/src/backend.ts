...
export class Backend implements backendInterface {
    ...
    async getCells(arg0: string): Promise<Array<Cell>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCells(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPresence(arg0: string): Promise<Array<Presence>> {
        if (this.processError) {
            try {
    ...
    async leaveDocument(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.leaveDocument(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCell(arg0: string, arg1: bigint, arg2: bigint, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCell(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
